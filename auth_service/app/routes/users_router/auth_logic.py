...
class PasswordSettings:
    ...
    def verify_password(self, plain_password: str, hashed_password: str) -> bool:
        ...
        print(f"  Plain password: {'*' * len(plain_password) if plain_password else 'EMPTY'}")
        ...
        if not isinstance(hashed_password, str):
            print(f"ERROR: Hashed password is not a string! Type: {type(hashed_password)}")
            return False
        ...
        try:
            ...
            if hashed_password:
                ...
                print(f"DEBUG: Hash starts with $2a$? {hashed_password.startswith('$2a$')}")
                print(f"DEBUG: Hash starts with $2y$? {hashed_password.startswith('$2y$')}")
            return False
