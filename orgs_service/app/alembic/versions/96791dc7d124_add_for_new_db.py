...
def upgrade() -> None:
    ...
    org_type_enum = postgresql.ENUM(
        'VUZ', 'COLLEGE', 'GBU', 'SCHOOL', 'MBU', 'ANO', 'FGBU', 'GAU', 'PO', 'OD', 
        'GKU', 'OOO', 'CHU', 'AO', 'MKU', 'ASSOCIATION', 'IP',
        name='org_type_enum'
    )
    ...
    op.add_column('organizations', sa.Column('knowledge_skills_z', sa.Float(), nullable=True))
    op.add_column('organizations', sa.Column('knowledge_skills_v', sa.Float(), nullable=True))
    op.add_column('organizations', sa.Column('digital_env_e', sa.Float(), nullable=True))
    op.add_column('organizations', sa.Column('data_protection_z', sa.Float(), nullable=True))
    op.add_column('organizations', sa.Column('data_analytics_d', sa.Float(), nullable=True))
